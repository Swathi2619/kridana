// src/components/FeesDetailsPage.jsx
        ...
        <div className="w-full bg-black rounded-2xl p-5 flex gap-4">
          ...
          <div className="flex flex-col gap-3 flex-[1] min-w-[260px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <StatBox label="Total Students" value="8,000" />
            </div>
          </div>
        </div>
      </div>
...
/* Small box component matching your 4 black cards */
