...
for (let i = 0; i < 12; i++) {
  const m = (selectedMonthIndex - 11 + i + 12) % 12;
...
{showDropdown && (
  <div className="absolute right-0 mt-3 w-48 bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-60 overflow-y-auto">
    {[...Array(12)].map((_, i) => {
      const d = new Date();
